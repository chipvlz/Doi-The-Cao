...
<head>
    ...
    <title>Forgot password {{$data['fullname'] }}</title>
            ...
            <div class="content">
                <table>
                    <tr>
                        ...
                        <td align="right"><h6 class="collapse">FORGOT PASSWORD</h6></td>
                    </tr>
                </table>
            </div>
                ...
                <table>
                    <tr>
                        <td>
                            ...
                            <p class="lead"> Bạn hoặc ai đó đã yêu cầu lấy lại mật khẩu  của tài khoản trên hệ thống  <a href="http://cms.ketqualive.vn"> Kết quả live </a>! </p>
                            <p class="lead"> Nếu đó đúng là yêu cầu của  bạn, vui lòng thực hiện theo hướng đẫn sau để đổi lại mật khẩu tài khoản <br/> <i> Yêu cầu sẽ hết hạn  sau 3 tiếng kể từ lúc request </i> : </p>
                            <!-- Callout Panel -->
                            <p class="callout">
                                Click vào đường dẫn sau để thực hiện đổi mật khẩu mới : <br/> <a class="btn" href="{{URL::route('auth.forget',['token'=>$data['token']])}}"> Reset Password ! &raquo;</a>
                            </p><!-- /Callout Panel -->
                            <!-- social & contact -->
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <h5 class="">Contact Info:</h5>
                                                        Email: <strong><a href="emailto:kqlive@vnnplus.vn@vnnplus.vn">info@vnnplus.vn</a></strong></p>
