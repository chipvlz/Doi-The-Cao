                ...
                <div class="content-enter">
                    <div class="contact-md hidden-md hidden-lg">
                        <h2 class="HotNew" style="position: relative;
                            ...
                            line-height: 25px;">
                            <span style="border-bottom: 2px solid #e02729;">Yêu Cầu Rút Tiền</span>
                        </h2>
                    </div>
                    ...
                    <div id="muaTheGate" class="InfoGoldCharge" style="display: block;">
                        <p class="text-warning text-center" style="font-style: italic"><b>Số tiền cần rút phải lớn hơn 100.000</b></p>
                        <form action="{{URL::route('post-bank.back-pay')}}" method="post">
                            {{csrf_field()}}
                                <div class="form-group" id="card-code-class">
                                    <label for="" class="control-label col-sm-4">
                                        <b>Tiền Cần Rút( Đơn vị vnđ)</b>
                                    </label>
                                    <div class="col-sm-8">
                                        <input name="money" type="number" required min="0" id="money" value="{{old('money')}}" class="form-control isNumber text-left">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-4 col-sm-offset-4">
                                        @if(\Auth::check())
                                            <input type="submit" name="" id="add-card" value="Rút Tiền"  class="RegNow">
                                        @else
