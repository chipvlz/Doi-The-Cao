                ...
                <div class="content-enter">
                    <div class="contact-md hidden-md hidden-lg">
                        <h2 class="HotNew" style="position: relative;
                            ...
                            line-height: 25px;">
                            <span style="border-bottom: 2px solid #e02729;">Lịch sử nạp tiền điện thoại</span>
                        </h2>
                    </div>
                    <div class="SideBar" style="float: left !important;">
                        <h2 class="HotNew">
                            <span>Lịch sử nạp tiền điện thoại</span>
                        </h2>
                    </div>
                    <!-- end BlockBank -->
                        ...
                        <div class="content-search" style="margin-top: 30px">
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                    @if(Auth::check())
                                        @forelse($dataPayPhone as $item)
                                            <tr>
                                                <td>{{++$stt}}</td>
                                                <td><b class="text-success">{{$item->created_at}}</b></td>
                                                <td>{{$item->phone}}</td>
