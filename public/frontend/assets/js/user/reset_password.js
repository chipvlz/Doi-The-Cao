$(document).ready(function () {
    $(document).on('click', '#btn-change-password', function () {
        ...
        var message = '';
        message+= checkFieldEmpty(passwordCurrent, 'password_current', 'Bạn chưa nhập mật khẩu cũ');
        message+= checkFieldEmpty(passwordNew, 'password_new', 'Bạn chưa nhập mật khẩu mới');
        message+= checkLengthPassword(passwordCurrent, 'password_current', 'Mật khẩu phải từ 6 đến 8 ký tự');
